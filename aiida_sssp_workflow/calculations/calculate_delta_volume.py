...
@calcfunction
def calculate_delta_volume(pressures: orm.List, equilibrium_refs: orm.Dict,
    ...
    v_ref = get_volume_from_pressure_birch_murnaghan(pressure_reference.value,
                                                     V0, B0, BP)
    volumes = [
        get_volume_from_pressure_birch_murnaghan(p, V0, B0, BP)
        for p in pressures.get_list()
    ]
